...
The dataset contains information about recipes such as preparation time, number of ingredients, cooking steps, and user ratings. By combining recipe features with rating data, the project examines whether structural properties of recipes influence how users rate them.
